...
if __name__ == "__main__":
    ...
    print("システム状況: {status['unified_system']['system_health']}")
    print("現在精度: {status['unified_system']['current_accuracy']}%")
    print("目標達成: {status['unified_system']['accuracy_achievement']}")
